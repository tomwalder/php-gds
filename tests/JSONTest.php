...
class JSONTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @param $str_req
     */
    private function assertRequest($str_url, $str_req)
    {
        $this->assertEquals($str_url, $this->obj_fake_io->getRequestUrl());
        $this->assertEquals($str_req, $this->obj_fake_io->getRequestBody());
    }
